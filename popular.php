...
<html>
<head>
  <title>Popular| Tapnar | Best Images on Internet Worth Clicking</title>
  <meta charset="utf-8" />
...
<div class="scroll">
<?php include ('module/images/popular.php'); ?>
...
$('.scroll').jscroll({
  debug:true ,
          loadingHtml: '<div><center><img src="http://tapnar.com/zone/zupload/src/f61qwse48q.jpg" /></center></div>',
    padding: 20
});
</script>
<!-- COntent Ends -->
