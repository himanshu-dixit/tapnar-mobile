...
<div id="top_bar">
<a href="login.php">
<div class="signin" style="padding-left:25px;">LOGIN</div></a>
  <div>
</div>
</div></div>
...
<div>
<center>
<div class="facebook_login" id="facebook_connect"><center>Signup With Facebook</center></div></center>

<div class="or">
  <center>OR</center></div>
  <center>
    <div class="email">
      <input id="name" name="name" placeholder="Name" type="text" style="width:400px;height:60px;padding-left:15px; border: none !important;">
    </div>
  </center>

<center>
  <div class="email">
    <input id="email" name="email" placeholder="Email" type="text" style="margin-top:10px;width:400px;height:60px;padding-left:15px; border: none !important;">
  </div>
</center>
...
<center>
<div class="button" id="email_connect"><center>SIGN UP</center></div></center>

<div class="join_tapnar" style="margin-top:20px;"><center>
<span class="no_account">Alredy Have A Account | </span><a href="login.php"> <span class="join_tapnar">LOGIN</span></a>
</center>
</div>
